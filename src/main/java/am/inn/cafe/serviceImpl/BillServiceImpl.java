...
import am.inn.cafe.dao.BillDao;
...
public class BillServiceImpl implements BillService {
    ...
    private byte[] getByteArray(String filePath) throws Exception {
        ...
        InputStream targetStream = new FileInputStream(initiaFile);
        byte[] byteArray = IOUtils.toByteArray(targetStream);
        targetStream.close();
        return byteArray;
    }

    private void addRows(PdfPTable table, Map<String, Object> date) {
        log.info("Inside addRows");
        table.addCell((String) date.get("name"));
        table.addCell((String) date.get("category"));
        table.addCell((String) date.get("quantity"));
        table.addCell(Double.toString((Double) date.get("price")));
        table.addCell(Double.toString((Double) date.get("total")));
    }
    ...
    private void insertBill(Map<String, Object> requestMap) {
        try {
            Bill bill = Bill.builder()
                    ...
                    .total(Integer.getInteger((String) requestMap.get("totalAmount")))
                    .productDetail((String) requestMap.get("productDetail"))
